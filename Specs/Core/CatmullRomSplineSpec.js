...
defineSuite([
    ...
    it('computes start and end tangents', function() {
        var controlPoint0 = Cartesian3.clone(points[0], new Cartesian3());
        var controlPoint1 = Cartesian3.clone(points[1], new Cartesian3());
        var controlPoint2 = Cartesian3.clone(points[2], new Cartesian3());

        var start = Cartesian3.multiplyByScalar(Cartesian3.subtract(Cartesian3.subtract(Cartesian3.multiplyByScalar(controlPoint1, 2.0, new Cartesian3()), controlPoint2, new Cartesian3()), controlPoint0, new Cartesian3()), 0.5, new Cartesian3());
        ...
        var end = Cartesian3.multiplyByScalar(Cartesian3.add(Cartesian3.subtract(controlPointn0, Cartesian3.multiplyByScalar(controlPointn1, 2.0, new Cartesian3()), new Cartesian3()), controlPointn2, new Cartesian3()), 0.5, new Cartesian3());
